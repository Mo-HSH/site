                                        ...
                                        >
                                            ...
                                            <Flex style={{width: "90%"}} vertical={true}>
                                                ...
                                                <Typography.Text style={{marginTop: "10px", textAlign: "justify"}}>
                                                    ضمن آرزوی موفقیت برای جنابعالی در تمام مراحل زندگی فردی و اجتماعی از
                                                    اهتمام
                                                    شایسته، تلاش
                                ...
                                >
                                    ...
                                    <Row style={{width: "90%"}} gutter={[12, 0]}>
                                        <Col span={19} style={{height: "100%"}}>
                                            <Row style={{
                                            ...
                                            }}>
                                                {
                                                    [
                                                        ...
                                                        return (
                                                            <>
                                                                <Col flex={1} style={{borderLeft: "solid black 1px"}}>
                                                                    <Flex justify={"center"} align={"center"}
                                                                          style={{width: "100%", height: "100%"}}>
                                            ...
                                            <Row style={{height: "50%", border: "solid black 2px", borderTop: 0}}>
                                                {
                                                    [
                                                        {label: "نام پدر", data: soldier["father_name"]},
                                                        {
                                    ...
                                    <Flex style={{width: "90%", marginTop: "20px", textAlign: "justify"}}>
                                        <Typography.Text>
                                            ...
                                            از خدمت مقدس سربازی ترخیص که چگونگی در ماده دستور این یگان درج گردیده است.
                                            لذا خواهشمند است دستور فرمائید در این مورد بررسی و چنانچه نامبرده از نظر
                                            مالی و اداری فاقد مشکل می باشد، محل مربوطه راامضاء و ممهور به مهر فرمائید.
                                            (ضمناً مهلت تکمیل تسویه حساب از تاریخ صدور یک هفته می باشد و بدیهی است در
                                                                          ...
                                                                          style={{width: "100%", height: "100%"}}>
                                                                        {
                                                                            all.length - 1 === index && innerAll.length - 1 === innerIndex
                                                                                ...
                                                                                <Typography.Text
                                                                                    ...
                                                                                    رئیس دایره وظیفه های مد ن ا و پش
                                                                                    مرکز نپاجا
                                                                                    <br/>
                                                                                    {releaseSign}
                                                                                </Typography.Text>
                                ...
                                >
                                    ...
                                    <Flex style={{width: "90%"}}>
                                        <Typography.Text style={{textAlign: "justify"}}>
                                            ...
                                            ترخیص و از همان تاریخ کلیه حقوق و مزایای نامبرده فطع
                                            میگردد.
                                        </Typography.Text>
                                    </Flex>
