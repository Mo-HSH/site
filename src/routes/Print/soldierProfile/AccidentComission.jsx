        ...
        axios.get(getApiUrl("config/signs"), {withCredentials: true}).then((res) => {
            ...
            res.data.config.forEach(({key, value}) => {
                if ([
                    ...
                    "رئیس بازرسی ف پشتیبانی نیروی پدافند هوایی آجا",
                    "نماینده اداره بهداشت و امداد و درمان نیروی پدافند هوایی آجا",
                    "نماینده عقیدتی سیاسی ف پشتیبانی نیروی پدافند هوایی آجا",
                    "نماینده حفاظت اطلاعات ف پشتیبانی نیروی پدافند هوایی آجا",
