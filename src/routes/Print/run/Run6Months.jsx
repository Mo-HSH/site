                ...
                if (res.length === 0) {
                    ...
                    setSoldier({
                        ...
                        "target_run": {
                            ...
                            "run_status": res[0]["run"][runIndex]["run_status"],
                        },
                    });
                ...
                <Flex justify={"center"} align={"center"} vertical={true} ref={printComponent}
                    ...
                    >
                        ...
                        <Flex style={{width: "90%"}} vertical={true}>
                            ...
                            <Typography.Text>
                                {
                                    soldier["unit"] === "فرماندهی پشتیبانی مرکز نپاجا - ت.ح" ? "به: فرماندهی محترم حفاظت اطلاعات فرماندهی پشتیبانی مرکز نیروی پدافند هوایی آجا" : "به: فرماندهی محترم گروه خدمات و پاسداری ف پشتیبانی مرکز نیروی پدافند هوایی آجا"
                                }
                            </Typography.Text>
